...
- During the first day of the voyage, Vincent drops a crate on himself and loudly exclaims he has cracked a rib. minor healing/healing spells don't fully heal him, and he must stay out of combat. 
...
- Later on, Vincent approaches the party and speaks to them in a friendly manner, talking to them as if they were pals. He nonchalantly tells them to avoid going to the brig. Zorra witnesses this from the sidelines.
- Vincent normally carries crates down to the bilge, but he motions for another crewman to do it. 
- Two sailors claim they spoke to the same crewman at the same time. Later, that crewman can't be found. 
- Some crewmen begin to go missing inexplicably. One says that they heard a scream in the night. The party notices one washes up on the hull and has a truly terrified face along with a massive chunk of his shoulder to rib missing, as if something large and heavy bludgeoned him.
...
- Zorra tells the party that she suspects the captain... he has been acting strange this whole time, and he has forgotten nicknames of some of the crewmen. 
...
If combat starts during long rest:
- Resting members are guaranteed surprised in combat and miss their first turn (they are belowdeck resting). Encourages someone to always be on lookout.

If combat breaks out:
- The doppleganger _always_:
    - Uses Help once
    - Gives commands to PC's and crew. Gives hints of secondary objectives
    - Withdraws
- Never attacks unless cornered
- Never takes a “hero moment”
- Zorra is:
...
- Explain the **Weather Jewel**: a prized possession of the Isles that was obtained long ago, it was kept under utmost security by the Council of Three... the decision makers of the Isles.
...
- **Stormhold's Labyrinth**: 



# Skullkeepers Voyage Arc

## SESSION GOAL
- Build paranoia and tension
- Allow players to solve the doppleganger mystery
- Transition cleanly into pirate hideout infiltration

---

## DAY 0 — DOCKS (BEFORE DEPARTURE)
- Introduce Captain Vincent (real)
  - Sniffs party, claims they smell foul
...
## DAY 1 — SUBTLE WRONGNESS
Clues:
- Captain avoids lifting crates
- Delegates physical labor
- Avoids the brig
- Friendly tone shift toward PCs
- Casually tells PCs to avoid the brig

Optional Encounter:
- Minor sea threat: **Pirate ship on the horizon, must turn off lamps w/ help of crew**
- Captain commands but does not fight

Morale Check:
- No change unless players provoke tension

## NIGHT 2 — FIRST DEATH
Events:
- Scream heard during night
- Crewman missing
- Blood in hold

Later:
- Body washes against hull
- Massive bludgeoning wound
...
- Crewman A's sanity questioned

This confirms impersonation exists.
...
IF players act:
- Searching brig reveals Vincent (alive)
...
- Players search brig
- Doppleganger attempts frame or escape

Encounter:
- Doppleganger fight (environmental, deceptive)
- Uses shifting, confusion, hostages
...
- Zorra thanks Skullkeepers publicly

Morale:
- +2 to +4 depending on outcome

## APPROACHING PIRATE HIDEOUT
Situation:
- Pirate activity heightened
- Direct approach is dangerous

Options:
- Night landing by rowboat
- Smuggler's inlet
- Decoy maneuver using ship

Transition:
- Stealth infiltration arc begins
